 ...
 */
public class MainTeoricaTabelaHashComIncrementoPorHash {

    public static void main(String[] args) {
        TabelaHashComIncrementoPorHash<Long, Pessoa> tabelaHashPessoasBI =
                new TabelaHashComIncrementoPorHash<>(5);
